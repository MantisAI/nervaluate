...
def test_entity_scenarios_strict():
    """Test various entity boundary scenarios."""
    # Test case 1: PER entity with correct boundary, LOC entity with correct boundary
    true = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "I-LOC"]]
    pred = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "I-LOC"]]
    ...
    # Test case 2: PER entity with correct boundary, LOC entity with incorrect boundary
    true = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "I-LOC"]]
    pred = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "O"]]
    evaluator = Evaluator(true, pred, tags=["PER", "LOC"], loader="list")
    results = evaluator.evaluate()
    ...
    # # Test case 3: PER entity with correct boundary, LOC entity with incorrect boundary (shifted)
    # true = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "I-LOC"]]
    # pred = [["O", "B-PER", "I-PER", "O", "O", "O", "O", "B-LOC"]]
    # evaluator = Evaluator(true, pred, tags=["PER", "LOC"], loader="list")
    # results = evaluator.evaluate()
    ...
    # # Test case 4: PER entity with correct boundary, LOC entity with incorrect boundary, extra PER entity
    # true = [["O", "B-PER", "I-PER", "O", "O", "O", "B-LOC", "I-LOC"]]
    # pred = [["O", "B-PER", "I-PER", "O", "B-PER", "O", "B-LOC", "I-LOC"]]
    # evaluator = Evaluator(true, pred, tags=["PER", "LOC"], loader="list")
    # results = evaluator.evaluate()

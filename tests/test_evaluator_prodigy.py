...
def test_evaluator_simple_case_filtered_tags():
    ...
    evaluator = Evaluator(true, pred, tags=['PER', 'LOC'], list=False)
...
def test_evaluator_extra_classes():
    ...
    evaluator = Evaluator(true, pred, tags=['ORG', 'FOO'], list=False)
...
def test_evaluator_no_entities_in_prediction():
    ...
    evaluator = Evaluator(true, pred, tags=['PER'], list=False)
...
def test_evaluator_compare_results_and_results_agg_1():
    ...
    evaluator = Evaluator(true, pred, tags=['PER', 'ORG', 'MISC'], list=False)
